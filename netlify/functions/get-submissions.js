...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    const result = await pool.query('SELECT id, child_name, parent_name, parent_email, score, total_questions, expectations, submitted_at, detailed_results FROM assessmentsks2 ORDER BY submitted_at DESC');
